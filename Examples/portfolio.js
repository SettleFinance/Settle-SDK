...
Settle(process.env.SETTLE_JSAPI, '/api/public/PortfolioTracker/Summary', { user_id })
.then((result) => {
  console.log('Summary')
})
.catch((reason)=>{
...
Settle(process.env.SETTLE_JSAPI, '/api/public/PortfolioTracker/Holdings', { user_id })
.then((result) => {
...
Settle(process.env.SETTLE_JSAPI, '/api/public/PortfolioTracker/HoldingsWithTrades', { user_id })
.then((result) => {
...
Settle(process.env.SETTLE_JSAPI, '/api/public/PortfolioTracker/Trades', { user_id })
.then((result) => {
  console.log('Trades')
})
.catch((reason)=>{
...
Settle(process.env.SETTLE_JSAPI, '/api/public/PortfolioTracker/Exchanges', { user_id })
.then((result) => {
...
Settle(process.env.SETTLE_JSAPI, '/api/public/PortfolioTracker/BalanceHistory', { user_id })
.then((result) => {
